                ...
                <div class="section-wrapper">
                    <div class="cart-top">
                        <table>
                            <thead>
                                <tr>
                                    <th class="cat-quantity text-center">Morning</th>
                                    <th class="cat-quantity text-center">Time</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="text-center"> Open</td>
                                    <td class="text-center"> {{$pooja->morning_open}}</td>
                                </tr>
                                <tr>
                                    <td class="text-center"> Close</td>
                                    <td class="text-center"> {{$pooja->morning_close}}</td>
                                </tr>
                            </tbody>
                            <thead>
                                <tr>
                                    <th class="cat-quantity text-center">Evening</th>
                                    <th class="cat-quantity text-center">Time</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="text-center"> Open</td>
                                    <td class="text-center"> {{$pooja->evening_open}}</td>
                                </tr>
                                <tr>
                                    <td class="text-center"> Close</td>
                                    <td class="text-center">{{$pooja->evening_close}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
